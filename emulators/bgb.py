...
class BGBRC(Emulator):
    ...
    def startProcess(self, rom, *, gbc=False):
        return subprocess.Popen(["emu/bgb/bgb-159-rc64.exe", "-set", "SystemMode=%d" % (1 if gbc else 0), "-set", "Speed=%g" % (self.speed), "-set", "LoadRomWarnings=0", "-set", "Width=160", "-set", "detectgba=1", "-set", "Height=144", "-set", "SoundOut=null", os.path.abspath(rom)], cwd="emu/bgb")
